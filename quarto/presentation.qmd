---
title: "🍷 À boire 🍻"
subtitle: "*Wine Scraping : Le breuvage contre-attaque*"
author: "`Guillaume DEVANT` & `Corentin DUCLOUX`"
title-slide-attributes:
    data-background-image: "img/background_wine.jpg"
...
## 🔬 Metrics {.smaller background-image="img\metrics.jpeg" background-opacity="0.20"}
...
## Choix du stockage, Partie II {.smaller background-image="img\homme_en_couple.jpeg" background-opacity="0.25"}
...
## 🚀 Démonstration {background-image="img\fusee.jpeg" background-opacity="0.25"}
...
## 🏗️ Le conteneur en action ! {.smaller background-image="img\img_docker.webp" background-opacity="0.35"}
...
## Fin {.smaller background-image="img\findumonde.jpeg" background-opacity="0.25"}
...
- Guide Utilisateur : [`scickit-learn`](https://scikit-learn.org/stable/user_guide.html)
