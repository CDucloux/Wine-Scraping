...
- transforme une colonne catégorique en plusieurs colonnes binaire

- optimisation des paramétres  et strategie d'imputation par CV
- Pour chaque modèle on a decidé d'optimiser entre 2 et 3 hyperparamètre.

- résultats sont stocké dans un CSV avec les score, ET, et valeur des hyperparamètres.
:::
...
:::{.notes}
- Tous les modules ont leur tests associés
:::
...
Mais bon c'est bien beau ces lignes de description, pourrais-tu être un peut plus poétique ?
:::
...
::: {.notes}
- Projet commençant a etre bien fournis, nécéssité de modularisé le tout pour apporter un peu de clareté pour le développeur
:::
